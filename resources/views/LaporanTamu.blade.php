...
<div class="box-border">
        <div class="center">
            ...
            <h5 style="text-align:center; font-weight: 900;">LAPORAN JUMLAH TAMU</h5>
            
        </div>
            <div>
            <div class='text-center'> Tahun : {{$tahun}}</div>
            <div class='text-center'> Bulan : {{$bulan}}</div>
                <table class="table w-full">
                    ...
                    <tr>
                        ...
                        <th class="th">{{$item->total_kamar_grup}}</th>
                        <th class="th">{{$item->total_kamar_personal}}</th>
                        <td class="td">{{$item->total_kamar_all}}</td>
                    </tr>
                    </tr>
                    @endforeach
                    <tr>
            ...
            <td class="td text-bold">{{$totalKamar}}</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <table class="table">
      <tbody>
        <tr>
          <td class="w-80"></td>
          <td class="w-50">Dicetak tanggal {{$tanggal}}</th>
        </tr>
      </tbody>
    </table>
    <br/>
