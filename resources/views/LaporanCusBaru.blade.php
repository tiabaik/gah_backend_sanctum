...
<div class="box-border">
        <div class="center">
            ...
            <h5 style="text-align:center; font-weight: 900;">LAPORAN CUSTOMER BARU</h5>
            ...
            <div class='text-center'> Tahun {{$tahun}}</div>
                <table class="table w-full">
                    ...
                    <tr>
                        ...
                        <th class="th">{{$item->nama_bulan}}</th>
                        <td class="td">{{$item->jumlah_custumer_baru}}</td>
                    </tr>
                    </tr>
                    @endforeach
                 <tr>
            ...
            <td class="td text-bold">{{$totalCustumer}}</td>
          </tr>
        </tbody>
      </table>
    </div>
